...
public partial class ledger_master : System.Web.UI.Page
{
        ...
        try
        {
            ...
            else if (ledgercode != "" || acctypcode != "")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    dtledger.Columns.Add("SNo", typeof(string));
                    dtledger.Columns.Add("Header Name", typeof(string));
                    dtledger.Columns.Add("Group Name", typeof(string));
                    dtledger.Columns.Add("Ledger Name", typeof(string));
                    dtledger.Columns.Add("Account Type", typeof(string));
                    dtledger.Columns.Add("Fee Type", typeof(string));
                    dtledger.Columns.Add("Purpose", typeof(string));
                    dtledger.Columns.Add("Set Priority", typeof(string));
                    dtledger.Columns.Add("Priority", typeof(string));
                    ...
                    {
                        drleg = dtledger.NewRow();

                        drleg["SNo"] = Convert.ToString(row + 1);
    ...
    public void bindheader(Object sender, EventArgs e)
    {
        try
        {
            cblheader.Items.Clear();
            ...
            string feetype = Convert.ToString(grdledger.Rows[rowIndex].Cells[3].Text);
    ...
    protected void btn_update_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //string desc = Convert.ToString(txt_desc.Text);
            //desc = System.Threading.Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(desc);
            //string groupname = Convert.ToString(grdledger.Rows[rowIndex].Cells[2].Text);
