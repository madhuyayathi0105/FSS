            ...
            if (Radioformat1.Checked == true)
            {
                ...
                if (dtDegInfo.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtDegInfo.Rows)
                    {
                        ...
                        query += " select StudMessType,* from Registration r,Degree d,Department de,course c,HT_HostelRegistration hr where r.degree_code=d.degree_code and d.Dept_Code=de.Dept_Code and d.Course_Id=c.Course_Id and r.degree_code in('" + degCode + "') and r.college_code='" + ddlCollege.SelectedItem.Value + "' and stud_Type='Hostler' and DelFlag='0' and Exam_Flag='OK' and (cc='False' or cc=0) and r.App_No=hr.APP_No and MemType='1'";
                        ...
                        query += "  select  distinct r.Roll_No,StudMessType from Registration r,Degree d,Department de,course c,DayScholourStaffAdd ds  where r.degree_code=d.degree_code and d.Dept_Code=de.Dept_Code and d.Course_Id=c.Course_Id and r.degree_code in('" + degCode + "') and r.college_code='" + ddlCollege.SelectedItem.Value + "' and r.Roll_No=ds.Roll_No and   DelFlag='0' and Exam_Flag='OK' and (cc='False' or cc=0) AND r.App_No not in (select APP_No from HT_HostelRegistration)";
