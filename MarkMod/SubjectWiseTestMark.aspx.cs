...
public partial class MarkMod_SubjectWiseTestMark : System.Web.UI.Page
{
    ...
    ArrayList headercolnote = new ArrayList();
    ArrayList colofvisfalse = new ArrayList();
    int[] rowsofvisible =new int[10];
    int headcolspanstart = 0;
    int firstcolspan = 0;
    //int colspanstart = 0;
    //====================================//
    ...
    public void Init_Spread(ref int startColumm, int endColumn, int type = 0)
    {
        try
        {
            ...
            if (type == 0)
            {
                ...
                dtl.Columns.Add("SNo", typeof(string));
                dtl.Rows[0][colu] = "SNo";
                colu++;
                colofvisfalse.Add("true");
                headercoltag.Add("0000");
                headercolnote.Add("0000");
                ...
                colu++;
                colofvisfalse.Add(Convert.ToString(isRollNoVisible));
                headercoltag.Add("0000");
                headercolnote.Add("0000");
                ...
                colu++;
                colofvisfalse.Add(Convert.ToString(isRegNoVisible));
                headercoltag.Add("0000");
                headercolnote.Add("0000");
                ...
                colu++;
                colofvisfalse.Add(Convert.ToString(isAdmissionNoVisible));
                headercoltag.Add("0000");
                headercolnote.Add("0000");
                ...
                headcolspanstart = dtl.Columns.Count;
            ...
            else
            {
                ...
                dtl.Columns.Add("Subject Code", typeof(string));
                dtl.Rows[0][colu] = "Subject Code";
                colu++;
                colofvisfalse.Add("true");
                headercoltag.Add("0000");
                headercolnote.Add("0000");
    ...
    protected void btnGetMarks_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dtStudentMarks.Rows.Count > 0)
            {
                ...
                Init_Spread(ref spanStartColumn, 0);
                ...
                if (dtDistinctSubject.Rows.Count > 0)
                {
                    foreach (DataRow drSubjects in dtDistinctSubject.Rows)
                    {
                        ...
                        foreach (DataRow header in DistinctSubject.Rows)
                        {
                            ...
                            dtl.Columns.Add(subjectNames, typeof(string));
                            dtl.Rows[0][dtl.Columns.Count-1] = subjectNames;
                            dtl.Rows[1][dtl.Columns.Count - 1] = Convert.ToString(header["subSubjectName"] + "\n");
                            colofvisfalse.Add("true");
                            headercoltag.Add(Convert.ToString(header["subjectId"]));
                            headercolnote.Add("0000");
                        }
                        //-----------------------------
                       

                        dtl.Columns.Add("Marks\n", typeof(string));
                        dtl.Rows[0][dtl.Columns.Count - 1] = subjectNames;
                        dtl.Rows[1][dtl.Columns.Count - 1] = "Marks\n"; 
                        colofvisfalse.Add("true");
                        headercoltag.Add(subjectNos);
                        headercolnote.Add("0");
                        ...
                        dtl.Columns.Add("Mark\n" + displayOutof100, typeof(string));
                        dtl.Rows[1][dtl.Columns.Count - 1] = "Mark\n" + displayOutof100;
                        colofvisfalse.Add(Convert.ToString( ((chkConvertedTo.Checked && txtConvertedMaxMark.Enabled && convertedMax > 0) ? true : false)));
                        headercoltag.Add("0000");
                        headercolnote.Add("0000");
                        //FpStudentMarkList.Sheets[0].ColumnHeaderSpanModel.Add(0, FpStudentMarkList.Sheets[0].ColumnCount - 2, 2, 1);
                        

                        dtl.Columns.Add("Grade", typeof(string));
                        dtl.Rows[1][dtl.Columns.Count - 1] = "Grade";
                        colofvisfalse.Add(Convert.ToString((chkIncludeGrade.Checked)));
                        headercoltag.Add("0000");
                        headercolnote.Add("0000");
                ...
                if (dtDistinctSubjectTypeSingle.Rows.Count > 0)
                {
                    foreach (DataRow drSubjectType in dtDistinctSubjectTypeSingle.Rows)
                    {
                        ...
                        dtl.Columns.Add("Marks\n", typeof(string));
                        dtl.Rows[0][dtl.Columns.Count - 1] = subjectType;
                        dtl.Rows[1][dtl.Columns.Count - 1] = "Marks\n";
                        colofvisfalse.Add("true");
                        headercoltag.Add(subjectNoList);
                        headercolnote.Add("1");
                ...
                int endColumn = dtl.Columns.Count-1;
                if (dtDistinctStudents.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow drStudent in dtDistinctStudents.Rows)
                    {
                        ...
                        subjectCodeVal = Convert.ToString(headercolnote[dtl.Columns.Count - 3].ToString());

                        

                        subjectNoVal = Convert.ToString(headercoltag[dtl.Columns.Count - 3].ToString());

                        

                        subjectNameVal = Convert.ToString(dtl.Rows[0][dtl.Columns.Count - 3].ToString());
                        ...
                        if (dvTestMark.Count > 0)
                        {
                            ...
                            {
                                if (testMark.ToUpper() == "AB")
                                {
                                }
                                else
                                {
                                    double testMk = Math.Round(Convert.ToDouble(testMark), 0);
                                    testMark = Convert.ToString(testMk);
                                }
                            }
                            ...
                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(serialNo).Trim();
                            ...
                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(rollNo).Trim();

                            
                            markCol++;
                            

                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(regNo).Trim();
                            ...
                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(admissionNo).Trim();

                            
                            markCol++;
                            

                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(studentType).Trim();

                            
                            markCol++;
                            
                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(gender).Trim();

                            
                            markCol++;
                            

                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(studentName).Trim();


                           
                            

                            endColumn = Convert.ToBoolean(colofvisfalse[markCol].ToString()) ? markCol : endColumn;
                            ...
                            if (dsSubSubjectMarkList.Tables.Count > 0 && dsSubSubjectMarkList.Tables[0].Rows.Count > 0 && subjectNoList.Length == 1)
                            {
                                ...
                                if (dvSubSubjectMarks.ToTable().Rows.Count > 0)
                                {
                                    foreach (DataRowView SubjectPraticalDR in dvSubSubjectMarks)
                                    {
                                        ...
                                        string SubjectHeaderCode = Convert.ToString(headercoltag[markCol].ToString());
                                        ...
                                        if (SubjectID == SubjectHeaderCode)
                                        {
                                            ...
                                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(TestMark).Trim();
                                            if (TestMark == "Ab")
                                            {
                                                ...
                                                dtl.Rows[subjectRow + 2][markCol] = dtl.Rows[subjectRow + 2][markCol].ToString() + "^red";
                                            }
                                ...
                                else  //modified on 5/12/2017
                                {
                                    ...
                                    //dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(testMark).Trim() + "^red"; ;
                            ...
                            dtl.Rows[1][markCol] = "Marks\n" + display;
                            

                            
                            string color=(result) ? "Black" : "red";
                            if (color== "red")
                                dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(displayMark).Trim() + "^red"; 
                            else
                                dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(displayMark).Trim();
                            ...
                            if (color == "red")
                                dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(convertedObtainedMark).Trim() + "^red";
                            else
                                dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(convertedObtainedMark).Trim();
                            ...
                            dtl.Rows[subjectRow + 2][markCol] = Convert.ToString(displayGrade).Trim();

                            if (displayGrade == "--")
                            {
                                
                                dtl.Rows[subjectRow + 2][markCol] = dtl.Rows[subjectRow + 2][markCol] + "^red";
                            }
                    ...
                    int startingRows = dtl.Rows.Count - 3;

                    

                    columnVal = dtl.Rows.Count - 3;

                    firstcolspan = columnVal + 2;
                    // FpStudentMarkList.Sheets[0].SetColumnMerge(3, Farpoint.Model.MergePolicy.Always);
                    

                    dtl.Rows[columnVal + 2][0] = "TOTAL NO.OF ANSWER SCRIPTS EVALUATED: " + Convert.ToString(appearedCount).Trim();
                    //FpStudentMarkList.Sheets[0].SetColumnMerge(3, Farpoint.Model.MergePolicy.Always);
                    ...
                    dtl.Rows[columnVal + 2][0] = "SUBJECT AVERAGE: " + Convert.ToString(subjectAverage + "/" + convertedMark).Trim();
                    //FpStudentMarkList.Sheets[0].AddSpanCell(columnVal, 0, 1, 6);
                    //FpStudentMarkList.Sheets[0].SetColumnMerge(3, Farpoint.Model.MergePolicy.Always);
                    ...
                    dtl.Rows[columnVal + 2][0] = "HIGHEST SCORE: " + Convert.ToString(subjectHeighestMarks + "/" + convertedMark).Trim();
                    ...
                    dtl.Rows[columnVal + 2][0] = "LEAST SCORE: " + Convert.ToString(subjectLeastMarks + "/" + convertedMark).Trim();
                    ...
                    dtl.Rows[columnVal + 2][0] = "NO OF ABSENTEES: " + Convert.ToString(dicabsentees.Count).Trim();
                    //FpStudentMarkList.Sheets[0].AddSpanCell(columnVal, 0, 1, 6);
                    ...
                    if (CheckBox1.Checked == false)
                    {
                        ...
                        if (dtGeneralGrade.Rows.Count > 0)
                        {
                            ...
                            dtl.Rows[dtl.Rows.Count-1][0] = "MARKS";
                            ...
                            dtl.Rows[dtl.Rows.Count - 1][col] = "NUMBER OF STUDENTS";
                            ...
                            foreach (DataRow drGrade in dtGeneralGrade.Rows)
                            {
                                ...
                                dtl.Rows[dtl.Rows.Count - 1][0] = Convert.ToString(drGrade["Ranges"]).Trim();
                                ...
                                if (chkIncludeGrade.Checked)
                                {
                                    ...
                                    dtl.Rows[dtl.Rows.Count - 1][col] = Convert.ToString(grade).Trim();
                                ...
                                if (grade.ToLower().Trim() == "e")
                                {
                                    ...
                                    if (dicGradeWiseCount.ContainsKey(grade.Trim().ToLower()))
                                    {
                                        ...
                                        else if (failedstudent > dicabsentees.Count)
                                        {
                                            ...
                                            dtl.Rows[dtl.Rows.Count - 1][col] = Convert.ToString(failedstudent).Trim();
                                        }
                                    }
                                }
                                else
                                {
                                    ...
                                    dtl.Rows[dtl.Rows.Count - 1][col] = (!dicGradeWiseCount.ContainsKey(grade.Trim().ToLower())) ? "--" : Convert.ToString(dicGradeWiseCount[grade.Trim().ToLower()]).Trim();
                                }
                            ...
                            if (dtStudentMarks.Rows.Count > 0)
                            {
                                ...
                                dtl.Rows[dtl.Rows.Count - 1][0] = "No.of.Failure";
                                ...
                                if (testFail.Rows.Count > 0)
                                {
                                    ...
                                    dtl.Rows[dtl.Rows.Count - 1][col1] = Convert.ToString(testFail.Rows.Count);
                                }
                                else
                                {
                                    
                                    dtl.Rows[dtl.Rows.Count - 1][col1] = "--";
                                }
                    ...
                    dtl.Rows[columnVal + 2][0] = "NAME OF THE SUBJECT TEACHER : " + Convert.ToString(staffName).Trim();
                    ...
                    dtl.Rows[columnVal + 2][0] = "NAME OF THE EVALUATOR: ";

                    
                    rowsofvisible[0] = (columnVal + 2);
                    
                    dtl.Rows[columnVal + 2][6] = Convert.ToString("").Trim();
                    ...
                    dtl.Rows[columnVal + 2][0] = Convert.ToString("SIGNATURE OF THE EVALUATOR").Trim();

                    

                    rowsofvisible[1] = (columnVal + 2);
                    ...
                    dtl.Rows[columnVal + 2][0] = Convert.ToString("NAME OF THE EVALUATOR:").Trim();

                    

                    rowsofvisible[2] = (columnVal + 2);
                    ...
                    dtl.Rows[columnVal + 2][5] = Convert.ToString("").Trim();
                    ...
                    {
                        if (rowsofvisible[ccc] == i)
                        {
                            grdover.Rows[i].Visible = false;
                            ccc++;
                        }
                        ...
                        for (int j = 0; j < grdover.HeaderRow.Cells.Count; j++)
                        {
                            ...
                            if (i == 0 || i == 1)
                            {
                                ...
                                if (i == 0)
                                {
                                    ...
                                    if (j < headcolspanstart)
                                    {
                                        grdover.Rows[i].Cells[j].RowSpan = 2;
                                        for (int a = i; a < 1; a++)
                                            grdover.Rows[a + 1].Cells[j].Visible = false;
                                    }
                                    else if (j == headcolspanstart )
                                    {
                                        int span=grdover.HeaderRow.Cells.Count - headcolspanstart;
                                        grdover.Rows[i].Cells[j].ColumnSpan = span;
                                        for (int a = j + 1; a < j + span; a++)
                            ...
                            else
                            {
                                ...
                                string rrr = grdover.Rows[i].Cells[j].Text;
                                string[] splitval6 = rrr.Split('^');
                                if (splitval6.Length > 1)
                                {
                                    grdover.Rows[i].Cells[j].Text = splitval6[0].ToString();
                                    grdover.Rows[i].Cells[j].ForeColor = Color.Red;
                                    grdover.Rows[i].Cells[j].BorderColor = Color.Black;
                                    

                                }
                                else
                                    grdover.Rows[i].Cells[j].Text = rrr;
                                


                                if (i >= grdover.Rows.Count - 6 && j==0 )
                                {
                                    if (chkIncludeGrade.Checked == true)
                                    {
                                        grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Left;
                                        grdover.Rows[i].Cells[j].ColumnSpan = grdover.HeaderRow.Cells.Count - (colfalsecount + 1);
                                        for (int a = j + 1; a < j + (grdover.HeaderRow.Cells.Count - 1); a++)
                                            grdover.Rows[i].Cells[a].Visible = false;
                                    }
                                    else
                                    {
                                        grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Left;
                                        grdover.Rows[i].Cells[j].ColumnSpan = grdover.HeaderRow.Cells.Count - (colfalsecount);
                                        for (int a = j + 1; a < j + (grdover.HeaderRow.Cells.Count); a++)
                                            grdover.Rows[i].Cells[a].Visible = false;
                                    }
                                }
                                else if (i >= firstcolspan && i < firstcolspan + 5 && j == 0)
                                {
                                    if (chkIncludeGrade.Checked == true)
                                    {
                                        grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Left;
                                ...
                                else if (i >= firstcolspan + 5 && i < grdover.Rows.Count - 6 && (j==0 || j==6 || j==7))
                                {
                                    if (j == 0)
                                    {
                                        grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Center;
                                        grdover.Rows[i].Cells[j].ColumnSpan = 6 - colfalinsideof6;
                                        for (int a = j + 1; a < j + 6; a++)
                                            grdover.Rows[i].Cells[a].Visible = false;
                                    }
                                    else
                                    {
                                        if (chkIncludeGrade.Checked && (j==6 || j==7))
                                        {
                                            if (j == 6  && i != grdover.Rows.Count - 7)
                                                grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Center;
                                            else
                                            {
                                                if (j == 6)
                                                {
                                                    grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Center;
                                                    grdover.Rows[i].Cells[j].ColumnSpan = (grdover.HeaderRow.Cells.Count - 6) - (colfalsecount - colfalinsideof6);
                                                }
                                                else
                                                {
                                                    grdover.Rows[i].Cells[j].HorizontalAlign = HorizontalAlign.Center;
                                                    grdover.Rows[i].Cells[j].ColumnSpan = (grdover.HeaderRow.Cells.Count - 7) - (colfalsecount - colfalinsideof6);
                                                }
                                                for (int a = j + 1; a < grdover.HeaderRow.Cells.Count; a++)
                                                    grdover.Rows[i].Cells[a].Visible = false;
                                            }
                                        }
                                        else if (j == 6)
    ...
    protected void btnPrintPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            rptheadname = "STATEMENT OF MARKS";
    ...
    public void btnPrint11()
    {
        ...
        spReportName.InnerHtml = "Subject Wise Test Mark Report";
