...
public class DAccess2
{
    ...
    public int send_sms(string user_id, string collegecode, string usercode, string mobilenos, string message, string isstaff, string smsSendFor = null, string studentAppNo = null, string TamilOrEng = null)
    {
        ...
        try
        {
            ...
            {
                //Aruna 04/07/2018 
                strpath = "http://unicel.in/SendSMS/sendmsg.php?uname=" + user_id + "&pass=" + Password + "&send=" + SenderID + "&dest=" + mobilenos + "&msg=" + message + "&unicode=1"; //&unicode=1 for tamil font
            }
            else
            {
                strpath = "http://unicel.in/SendSMS/sendmsg.php?uname=" + user_id + "&pass=" + Password + "&send=" + SenderID + "&dest=" + mobilenos + "&msg=" + message + "";
            }
