                            ...
                            <tr>
                                ...
                                <td class="style24">
                                    <asp:CheckBox ID="cbcumpercent" runat="server" Text="Cumulative %" Font-Bold="True"
                                        ...
                                        AutoPostBack="True" Style="margin-top: -9px; margin-left: -776px; position: absolute;
                                        height: 21px; width: 145px" />
                                    <asp:Label ID="lblcumfrm" runat="server" Text="From" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" Style="top: 180px; left: 512px; position: absolute; height: 21px;
                                        width: 38px"></asp:Label>
                                    <asp:TextBox ID="tbfmcumdate" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" Height="24px" Width="91px" Style="top: 176px; left: 563px;
                                        position: absolute;" OnTextChanged="tbfmcumdate_TextChanged" AutoPostBack="True"></asp:TextBox>
                                    ...
                                    <asp:Label ID="lblcumto" runat="server" Text="To" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" Style="top: 180px; left: 663px; position: absolute; height: 21px;
                                        width: 20px"></asp:Label>
                                    <asp:TextBox ID="tbtocumdate" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" Height="24px" Width="90px" Style="top: 176px; left: 691px;
                                        position: absolute;" OnTextChanged="tbtocumdate_TextChanged" AutoPostBack="True"></asp:TextBox>
                                    ...
                                    <asp:CheckBox ID="cbpoints" runat="server" Text="Attnd Points" Font-Bold="True" Width="115px"
                                        Font-Names="Book Antiqua" Font-Size="Medium" Height="21px" Style="top: 180px;
                                        left: 793px; position: absolute;" />
                                </td>
                            </tr>
                        </table>
                        <table>
