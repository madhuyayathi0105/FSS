...
public partial class Periodwiseattendancereport : System.Web.UI.Page
{
    ...
    protected void btnprint1_Click(object sender, EventArgs e)
    {
        ...
        Printcontrol.loadspreaddetails(Showgrid, "Periodwiseattendancereport.aspx", "PERIOD WISE CONSOLIDATED STUDENT'S ATTENDANCE@Date : " + txtFromDate.Text + " @Period: " + ddlhour.SelectedItem.ToString() + "", 0, ss);
