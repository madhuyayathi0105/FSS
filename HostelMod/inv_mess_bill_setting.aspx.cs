...
public partial class inv_mess_bill_setting : System.Web.UI.Page
{
    ...
    protected void btn_generate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            days = ts.Days;
            days++;
            string holidayquery = " select COUNT(*)as holiday_count from HT_Holidays where HolidayType='1' and HolidayForDayscholar ='1' and HolidayForHostler ='1' and  HolidayForStaff ='1' and HolidayDate between '" + dt.ToString("MM/dd/yyyy") + "' and '" + dt1.ToString("MM/dd/yyyy") + "'";
            ds4.Clear();
