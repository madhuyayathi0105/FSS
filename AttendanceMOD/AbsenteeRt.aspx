                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:Panel ID="pnlCustomers" runat="server" BackColor="White" BorderColor="Black"
                                                        ...
                                                        <asp:CheckBoxList ID="ddlreport" runat="server" Font-Size="Medium" AutoPostBack="True"
                                                            ...
                                                            <asp:ListItem Value="3">OD</asp:ListItem>
                                                            <asp:ListItem Value="4">ML</asp:ListItem>
                                                            <asp:ListItem Value="5">SOD</asp:ListItem>
                                                            <asp:ListItem Value="6">NSS</asp:ListItem>
                                                            <asp:ListItem Value="7">H</asp:ListItem>
                                                            <asp:ListItem Value="8">NJ</asp:ListItem>
                                                            <asp:ListItem Value="9">S</asp:ListItem>
                                                            <asp:ListItem Value="10">L</asp:ListItem>
                                                            <asp:ListItem Value="10">NCC</asp:ListItem>
                                                            <asp:ListItem Value="12">HS</asp:ListItem>
                                                            <asp:ListItem Value="13">PP</asp:ListItem>
                                                            <asp:ListItem Value="14">SYOD</asp:ListItem>
                                                            <asp:ListItem Value="15">COD</asp:ListItem>
                                                            <asp:ListItem Value="16">OOD</asp:ListItem>
                                                            <asp:ListItem Value="17">LA</asp:ListItem>
                                                        </asp:CheckBoxList>
                                                    </asp:Panel>
