        ...
        int totVar = 0;
            ...
            if (dtStudentMarks.Rows.Count > 0)
            {
               ...
               // Init_Spread(FpStudentMarkList, ref spanStartColumn, 0);
                ...
                {
                    html.Append("<center><table  border='1px' cellpadding='7px' cellspacing='7px' style='margin-top: 40px ; border-collapse:collapse;border:1px solid black ; height:1800px ; width:2200px;margin-left:22px'><tr><td rowspan ='2px' style='text-align:center;font-size:18px;font-family:Arial;'><b>S.NO</b></td><td rowspan ='2px' style='text-align:center; font-size:18px;font-family:Arial;' ><b>ROLL NO</b></td><td rowspan='2px' style='text-align:center; font-size:18px;font-family:Arial;'><b>NAME OF THE STUDENT</b></td>");
                   ...
                   // html.Append("<table><tr><td>S.NO</td><td style='border: thin solid #000000; border-right-style: none;' align='center'  class='style1'>ROLL NO</td><td style='border: thin solid #000000; border-right-style: none;' align='center'  class='style1'>STUDENT NAME</td>");
                    ...
                    foreach (DataRow drNewColumns in dtHeading.Rows)
                    {
                        ...
                        html.Append("<td colspan='" + colsp + "px' style='text-align:center; font-size:19px;font-family:Arial;'><b>" + subjectNames + "</b></td>");
                ...
                html.Append("<td rowspan='2px' style='text-align:center; font-size:18px;font-family:Arial ;'><b>" + totval + "</b></td>");
                html.Append("<td rowspan='2px' style='text-align:center; font-size:18px;font-family:Arial ;'><b>RANK</b></td>");
                if (cbattndperc.Checked == true)
                {
                    html.Append("<td rowspan='2px' style='text-align:center; font-size:18px;font-family:Arial ;'><b>ATT%</b></td>");
                }
                html.Append("</tr>");
                ...
                if (diccolspan.Count > 0)
                {
                    ...
                    foreach (KeyValuePair<int, string> dc in diccolspan)
                    {
                        ...
                        html.Append("<td style='text-align:center; font-size:18px;font-family:Arial ;' ><b>" + colval + "</b></td>");
              ...
              //  int endColumn = FpStudentMarkList.Sheets[0].ColumnCount - 1;
                    ...
                    for (int k2 = 0; k2 < cout; k2++)
                    {
                        ...
                        if (brkpg == false)
                        {
                            if (sno4 >= pg_sz)
                            {
                                ...
                                if (dtColumnHeader.Rows.Count > 0)
                                {
                                    html.Append("<center><table border='1px' cellpadding='6px' cellspacing='6px' style='border-collapse:collapse;border:1px solid black ;height: 1800px;width:2250px;  margin-top: 50px;margin-left:22px '><tr><td rowspan='2px' style='text-align:center;font-size:18px;font-family:Arial'><b>S.NO</b></td><td rowspan='2px' style='text-align:center;font-size:18px;font-family:Arial'><b>ROLL NO</b></td><td rowspan='2px' style='text-align:center;font-size:18px;font-family:Arial'><b>NAME OF THE STUDENT</b></td>");
                                    DataTable dtHeading = new DataTable();
                                    dtColumnHeader.DefaultView.Sort = "subjectpriority";
                                    dtHeading = dtColumnHeader.DefaultView.ToTable();
                                    int cols = 0;
                                    foreach (DataRow drNewColumns in dtHeading.Rows)
                                    {
                                        ...
                                        html.Append("<td colspan='" + colsp + "px' style='text-align:center;font-size:18px;font-family:Arial'><b>" + subjectNames + "</b></td>");
                            ...
                            if (brkpg == false && hednam == false)
                            {
                                if (k2 == 6)
                                {
                                    if (FpStudentMarkList.Sheets[0].ColumnHeader.Columns[k2].Visible == true)
                                    {
                                        ...
                                        html.Append("<td style='font-size:20px;font-family:Arial'><b>" + colnam + "</b></td>");
                                ...
                                else
                                {
                                    if (FpStudentMarkList.Sheets[0].ColumnHeader.Columns[k2].Visible == true)
                                    {
                                        ...
                                        html.Append("<td style='text-align:center;font-size:20px;font-family:Arial'><b>" + colnam + "</b></td>");
                ...
                html.Append("</table></center></div><div style=' page-break-after: always; style='width:400px;margin-left:10px;'><table border='1px' cellpadding='7px' cellspacing='7px' style='border-collapse:collapse;border:1px balck solid;height:400px;width:230px;margin-top:95px;margin-left:22px'>");
                ...
                if (dtDistinctStudents.Rows.Count > 0)
                {
                    ...
                    if (dtGeneralGrade.Rows.Count > 0)
                    {
                        html.Append("<tr><td rowspan='2px' style='text-align:center;font-size:20px;font-family:Arial'><b>MARKS</b></td>");
                        if (chkIncludeGrade.Checked)
                        {
                            html.Append("<td rowspan='2px' style='text-align:center;font-size:20px;font-family:Arial'><b>GRADE</b></td>");                           
                        }
                        int ct = dicsubnam.Count;
                        html.Append("<td colspan='" + ct + "px' style ='text-align:center;font-size:20px;font-family:Arial'><b>NUMBER OF STUDENTS</b></td></tr><tr>");
                        ...
                        if (dicsubnam.Count > 0)
                        {
                            foreach (KeyValuePair<int, string> dic in dicsubnam)
                            {
                                ...
                                html.Append("<td style='text-align:center;font-size:20px;font-family:Arial'><b>" + subnam + "</b></td>");
                            }
                        }
                        html.Append("</tr>");
                        ...
                        foreach (DataRow drGrade in dtGeneralGrade.Rows)
                        {
                            ...
                            html.Append("<td style='text-align:center;font-size:20px;font-family:Arial'><b>" + rng + "</b></td>");
                          
                            string grade = Convert.ToString(drGrade["Mark_Grade"]).Trim();
                            if (chkIncludeGrade.Checked)
                            {
                                html.Append("<td style='text-align:center;font-size:21px;font-family:Arial'><b>" + grade + "</b></td>");
                            ...
                            if (dicsubno.Count > 0)
                            {
                                foreach (KeyValuePair<int, string> dic in dicsubno)
                                {
                                    ...
                                    html.Append("<td style='text-align:center;font-size:21px;font-family:Arial'><b>" + mk + "</b></td>");
                   ...
                   // html.Append("<table></table>");
                    html.Append("</table><table border='1px' cellpadding='3px' cellspacing='3px' style='border-collapse:collapse;border:1px solid black;margin-left:1220px;margin-top:-410px;height:400px;width:300px'>");
                    ...
                    if (chkrange.Checked == false)
                    {
                        ...
                        {
                            int ct = dicsubnam.Count;
                            html.Append("<tr><td rowspan='2px' style='text-align:center;font-size:20px;font-family:Arial'><b>MARKS</b></td><td colspan='" + ct + "px' style ='text-align:center;font-size:22px;font-family:Arial'><b>NUMBER OF STUDENTS</b></td></tr><tr>");
                            if (dicsubnam.Count > 0)
                            {
                                foreach (KeyValuePair<int, string> dic in dicsubnam)
                                {
                            ...
                            foreach (DataRow drGrade in dtGradeMarkRanges.Rows)
                            {
                                ...
                                if (dicsubno.Count > 0)
                                {
                                    foreach (KeyValuePair<int, string> dic in dicsubno)
                                    {
                                        ...
                                        html.Append("<td style='text-align:center;font-size:20px;font-family:Arial'><b>" + mk + "</b></td>");
                            ...
                            if (dtStudentMarks.Rows.Count > 0)
                            {
                                html.Append("<tr><td style='text-align:center;font-size:20px;font-family:Arial'><b>No.of.Failure (Below 35)</b></td>");
                                if (dicsubno.Count > 0)
                                {
                                    foreach (KeyValuePair<int, string> dic in dicsubno)
                                    {
                    ...
                    html.Append("<table cellpadding='15px'  style='margin-top:180px;margin-left:30px'><tr><td style='width:1150px;font-size:25px;font-family:Arial Black'>SIGNATURE OF THE CLASS TEACHER:</td><td style='font-size:25px;width:850px;font-family:Arial Black;Text-decoration:underline;' >CHECKED AND VERIFIED BY</td></tr><tr><td></td><td style='text-align:left;font-size:25px;font-family:Arial Black'>NAME OF THE TEACHER:</td></tr><tr><td></td><td style='text-align:left;font-size:25px;font-family:Arial Black'>SIGNATURE:</td></tr></table><table style='margin-left:50px;margin-top:50px'><tr><td style='font-size:25px;font-family:Arial Black;margin-left:-10px'>DIRECTOR</td></tr></table></div>");
