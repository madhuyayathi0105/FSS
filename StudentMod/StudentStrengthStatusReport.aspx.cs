    ...
    public void go1()
    {
        try
        {
            ...
            if (ddl_status.SelectedIndex < 2 || ddl_status.SelectedItem.Value == "11")
            {
                ...
                {
                    query = query + " select COUNT(distinct a.app_no)as TotalStrength, isdisable,isdisabledisc,islearningdis,handy " + Partlanguage + ",visualhandy,  mother_tongue, DistinctSport, CampusReq,A.degree_code,'' Exam_Flag,0 DelFlag,''cc,A.Batch_Year,a.Current_Semester,C.Course_Name ,Dt.Dept_Name,ISNULL(admission_status,'0') as admission_status ,'' sections,'' Stud_Type,a.seattype,a.quota,a.religion,a.community,a.mode,a.allotcomm from applyn a, degree d,Department dt,Course C where  d.Degree_Code =a.degree_code and d.Dept_Code =dt.Dept_Code and c.Course_Id =d.Course_Id   " + Isconfirm + "   and a.degree_code in('" + adddeg + "') and a.Batch_Year in('" + addbatch + "') and  a.Current_Semester in('" + addsem + "') and a.college_code='" + ddlcollege.SelectedItem.Value + "'  " + datebetween1 + "  group by isdisable,isdisabledisc,islearningdis,handy " + Partlanguage + ",visualhandy,mother_tongue,DistinctSport,CampusReq,a.degree_code ,a.Batch_Year,a.Current_Semester,C.Course_Name ,Dt.Dept_Name ,ISNULL(admission_status,'0'),Stud_Type,a.seattype,a.quota,a.religion,a.community,mode,a.allotcomm";//,Stud_prev_details s a.app_no =s.app_no  and abar
                    //case when CampusReq='0' then 'No' else 'Yes'  end as
                    //query = query + " select COUNT(a.app_no)as TotalStrength, A.degree_code,'' Exam_Flag,0 DelFlag,''cc,A.Batch_Year,a.Current_Semester,ISNULL(admission_status,'0') as admission_status ,'' sections from applyn a where isconfirm ='1'  and a.degree_code in('" + adddeg + "')and a.Batch_Year in('" + addbatch + "') and  a.Current_Semester in('" + addsem + "')   and a.college_code='" + ddlcollege.SelectedItem.Value + "'  " + datebetween1 + "   group by a.degree_code ,a.Batch_Year,a.Current_Semester,ISNULL(admission_status,'0')";
                ...
                else
                {
                    ...
                    else//old query Delsi
                    {
                        ...
                        else
                        {
                            ...
                            {
                                query = query + "  select COUNT(distinct a.app_no)as TotalStrength,r.Boarding,isdisable,isdisabledisc,islearningdis,handy " + Partlanguage + ",visualhandy, (Select textval FROM textvaltable T WHERE TextCode =ISNULL(mother_tongue,0))as mother_tongue,(Select textval FROM textvaltable T WHERE convert(varchar, TextCode)=isnull(DistinctSport,0)) DistinctSport,case when CampusReq='0' then 'No' else 'Yes'  end as CampusReq, r.degree_code, Exam_Flag,DelFlag,cc,ProlongAbsent,r.Batch_Year,r.Current_Semester,ISNULL(admission_status,'0') as admission_status ,sections,r.Stud_Type,a.seattype,a.quota,a.religion,a.community,r. mode,a.allotcomm from Registration r, applyn a,Stud_prev_details s   where  r.App_No =a.app_no and a.app_no =s.app_no  and isconfirm ='1'  and r.degree_code in('" + adddeg + "') and r.Batch_Year in('" + addbatch + "') and  r.Current_Semester in('" + addsem + "') and a.college_code='" + ddlcollege.SelectedItem.Value + "'  " + datebetween1 + "   group by isdisable,isdisabledisc,islearningdis,handy,visualhandy,mother_tongue,DistinctSport,CampusReq,r.degree_code ,r.Batch_Year,r.Current_Semester ,ISNULL(admission_status,'0'),r.Stud_Type,a.seattype,a.quota,a.religion,a.community,r.mode,Exam_Flag ,DelFlag,cc,ProlongAbsent,sections,r.Stud_Type" + Partlanguage + ",r.Boarding,a.allotcomm";//,Stud_prev_details s a.app_no =s.app_no and aba
                            }
                            query = query + "  select COUNT(a.app_no)as TotalStrength,a.mode, A.degree_code,Exam_Flag,DelFlag,cc,ProlongAbsent,A.Batch_Year,a.Current_Semester,ISNULL(admission_status,'0') as admission_status ,sections from applyn a,Registration r where a.app_no =r.App_No and isconfirm ='1'  and r.degree_code in('" + adddeg + "') and r.Batch_Year in('" + addbatch + "') and  a.Current_Semester in('" + addsem + "')  and  r.college_code='" + ddlcollege.SelectedItem.Value + "'  " + datebetween1 + "   group by a.degree_code ,a.Batch_Year,a.Current_Semester ,ISNULL(admission_status,'0'),Exam_Flag,DelFlag,cc,ProlongAbsent,Sections,a.mode  ";
                        }
